...
{
    undefinedColor = std::make_unique<Color>( _fromResourceTheme.getUndefinedColor() );
...
Color ResourceTheme::getUndefinedColor() const { return *undefinedColor; }
void ResourceTheme::setUndefinedColor(Color _undefinedColor) 
{ 
    undefinedColor = std::make_unique<Color>(_undefinedColor.toUint16());
    DisplayBuffer::bindColor(_undefinedColor.toUint16(), DisplayBuffer::colorCodes[0]);
}
